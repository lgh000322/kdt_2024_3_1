...
function ProductUploadPage() {
  ...
  const handleRemoveImage = (index) => {
    ...
    try {
      ...
      formData.append("addProductInforms" , new Blob([JSON.stringify(addProductInforms)], { type: "application/json" }));
          ...
          <div className="w-full max-w-4xl mx-auto p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="w-full">
                <label className="block text-sm text-gray-700 mb-2">최소 사이즈</label>
                <input
                  type="number"
                  name="min"
                  value={sizeRange.min}
              ...
              <div className="w-full">
                <label className="block text-sm text-gray-700 mb-2">최대 사이즈</label>
                <input
                  type="number"
                  name="max"
                  value={sizeRange.max}
              ...
              <div className="w-full">
                <label className="block text-sm text-gray-700 mb-2">사이즈 간격</label>
                <select
                  value={sizeInterval}
