...
//   const [representImageId, setRepresentImageId] = useState(null);
//   const [sideImgInforms, setSideImgInforms] = useState([]);
...
//           // 대표 이미지 설정
//           setRepresentImageId(data.mainImgId);
//           setRepresentImage({
...
//           setSideImgInforms(data.sideImgInforms);
  
//           // 사이즈별 재고 정보 설정
//           const sizeMap = {};
//           data.productDetailsList.forEach((detail) => {
//             sizeMap[detail.size] = {
//               quantity: detail.quantityBySize,
//               productDetailsId: detail.productDetailsId,
//             };
//           });
//           setExistingSizes(sizeMap);
  
//           // 사이즈 범위 설정
//           const sizes = data.productDetailsList.map((detail) => detail.size);
//           const min = Math.min(...sizes);
//           const max = Math.max(...sizes);
//           const interval = sizes[1] - sizes[0];
  
//           setSizeRange({ min: min.toString(), max: max.toString() });
//           setSizeInterval(interval);
//           setSizeQuantities(
//             Object.fromEntries(
//               data.productDetailsList.map((detail) => [
//                 detail.size,
//                 detail.quantityBySize.toString(),
//               ])
//             )
//           );
