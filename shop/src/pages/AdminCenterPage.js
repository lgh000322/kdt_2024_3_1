...
<<<<<<< HEAD
    <BasicLayout>
      <div className="max-w-7xl mx-auto px-4 pt-12"></div>
=======
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-100 p-5 rounded-lg shadow-md">
            ...
            <div className="flex justify-evenly items-center text-center mb-16">
              {["결제완료", "상품준비중", "배송지시", "배송중", "배송완료"].map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  {/* '>' 기호 추가 (마지막 항목 제외) */}
                  {index !== 4 && (
                    <div className="text-gray-400 text-xl font-bold mx-2">{'>'}</div>
                  )}
                </React.Fragment>
              ))}
            </div>
...
>>>>>>> ae3b056ded888015b5c3ec6725bd811bf897fcaa
    </BasicLayout>
  );
}
