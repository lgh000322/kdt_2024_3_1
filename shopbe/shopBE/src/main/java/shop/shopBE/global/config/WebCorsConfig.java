...
public class WebCorsConfig implements WebMvcConfigurer {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://api.fmanshop.com", "http://localhost:3000","https://kdt2024-3-1.vercel.app","https://www.fmanshop.com","https://fmanshop.com"));
        config.setAllowedHeaders(Arrays.asList("Authorization", "Content-Type", "X-Requested-With", "Cache-Control", "Access-Control-Allow-Origin","Set-Cookie"));
